...
* El juego podría jugarse simultaneamente por dos personas.
 ## Realización
### Base de datos 
* Aún no sabiamos manejo de archivos más allá de drive en colab así que nos decidimos por lo concido. Creamos un archivo en formato CSV en el que guardamos las más de 4000 palabras en los idiomas español, inglés, francés, y alemán. Cada idioma con su respectiva dificultada dada por la cantidad de letras. Aquí un pequeño fragmento: 
...
Empezamos programando la preparación del juego, es decir las posibilidades que tendria el jugador para un juego más dinamico:
   - Idioma:\
...
def idioma_y_nivel(base1):
    ...
    idioma = str(input("Ingrese 'español', 'inglés' o 'francés': "))
...
|____/ \____)_|| |_|_| |_|                                        
        ...
        opciones = base1[f'Palabra Francés Nivel {nivel}'].unique()#Se hace selección de la palabra 
        print("""  _____                 _            _             
 / ___ \               | |          (_)            
...
Descubrimos que existe una librería qu
